...
function Sidebar() {
  return (
    <div className="flex  h-full border border-r-zinc-400 dark:border-r-zinc-400">
        ...
        <div className="flex flex-col items-center h-full space-y-2 mt-5">
          ...
          <div className="flex flex-col bg-purple-700 rounded-2xl dark:bg-zinc-800">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <feColorMatrix
                      type="matrix"
                      values="0 0 0 0 0.196078 0 0 0 0 0.196078 0 0 0 0 0.278431 0 0 0 0.01 0"
                    />
                    <feBlend
                      mode="normal"
            ...
            <a href="#">
              ...
              >
                <path
                  d="M25.3724 22.2692C24.3515 24.6836 21.8455 26.1204 19.2461 25.7818C16.6467 25.4431 14.5925 23.4122 14.2242 20.8169C13.8559 18.2216 15.264 15.6993 17.6666 14.6509"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M25.8333 20C25.8333 18.4529 25.2188 16.9691 24.1248 15.8752C23.0308 14.7812 21.5471 14.1666 20 14.1666V20H25.8333Z"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <a href="#">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M19.9998 25.8333C23.2215 25.8333 25.8332 23.2216 25.8332 20C25.8332 16.7783 23.2215 14.1666 19.9998 14.1666C16.7782 14.1666 14.1665 16.7783 14.1665 20C14.1665 23.2216 16.7782 25.8333 19.9998 25.8333Z"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <a href="#">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M19.9998 14.1666C21.4589 15.764 22.2881 17.837 22.3332 20C22.2881 22.1629 21.4589 24.2359 19.9998 25.8333C18.5408 24.2359 17.7116 22.1629 17.6665 20C17.7116 17.837 18.5408 15.764 19.9998 14.1666V14.1666Z"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <a href="#">
              ...
              >
                ...
                />
                <path
                  d="M15.876 15.8757L17.5268 17.5266"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M22.4736 22.4734L24.1245 24.1242"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                ...
                />
                <path
                  d="M15.876 24.1242L17.5268 22.4734"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M22.4736 17.5266L24.1245 15.8757"
                  stroke="#D0D1D2"
                  stroke-width="1.16667"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div className="fixed bottom-0 left-0 ml-3 bg-purple-700 w-[50px] h-[50px] rounded-2xl justify-center flex flex-col items-center ">
          <a href="#">
            {" "}
            <svg
              width="14"
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M12.25 8.75C12.25 9.39433 11.7277 9.91667 11.0833 9.91667H4.08333L1.75 12.25V2.91667C1.75 2.27233 2.27233 1.75 2.91667 1.75H11.0833C11.7277 1.75 12.25 2.27233 12.25 2.91667V8.75Z"
                stroke="#422F8A"
                stroke-opacity="0.87"
                stroke-width="1.16667"
                stroke-linecap="round"
